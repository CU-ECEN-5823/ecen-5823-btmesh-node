...
cp ${EMLIB_DIR}/hardware/kit/common/drivers/retargetserial.h hardware/kit/common/drivers/
cp ${EMLIB_DIR}/hardware/kit/common/drivers/retargetserial.c hardware/kit/common/drivers/
cp ${EMLIB_DIR}/hardware/kit/common/drivers/retargettextdisplay.h hardware/kit/common/drivers/
cp ${EMLIB_DIR}/hardware/kit/common/drivers/retargetio.c hardware/kit/common/drivers/
...
mkdir -p protocol/bluetooth/lib/EFR32BG13P/GCC/
cp ${EMLIB_DIR}/protocol/bluetooth/lib/EFR32BG13P/GCC/libbluetooth.a protocol/bluetooth/lib/EFR32BG13P/GCC/
cp ${EMLIB_DIR}/protocol/bluetooth/lib/EFR32BG13P/GCC/libpsstore.a protocol/bluetooth/lib/EFR32BG13P/GCC/
