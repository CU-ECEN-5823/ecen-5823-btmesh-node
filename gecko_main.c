...
#if USE_DEFAULT_STACK_INIT
  // this is the initialization from the latest BLE mesh example from silicon labs
  // As new functions are added between releases of the mesh SDK, you may need to modify
  // functions used in client/server model initialization.
